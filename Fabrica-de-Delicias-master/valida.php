 <?php
        ...
        switch ($acao){
            ...
            case 'cadastroSor':
                    ...
                    if ($cpf == null OR $cnpj == null){
                        echo "<script>alert('Login ou Fornecedor incorreto');</script>";
                        include "view/cadastro.php";
                    }else {
            ...
            case 'editar':
                if (isset($_POST['cpf'])){
                    ...
                    $cpf = $crud->getUsuario($valores->getCpf());
                    $login = $cpf->getLogin();
                    $cnpj = $crud3->getFornecedor($valores->getCnpj());
                    $forNome = $cnpj->getNome();
            ...
            case 'editado':
                ...
                if ($_POST['idEdi'] == 1){
                    ...
                    $cpf = $crud->achaUsuario($_POST['cpf']);
                    $cnpj = $crud3->achaFornecedor($_POST['cnpj']);
                    $upSor = new Sorvete($_POST['id'],$_POST['nome'],$_POST['sabor'],$_POST['qtd'],$_POST['validade'],$_POST['data_ent'],$cnpj,$cpf);
                    ...
                    if (strlen($_POST['senha']) < 8 ){
                        ...
                        $usuarioAtivo = $_POST['cpfFun'];
                        $upFun = new Usuario($_POST['cpfFun'], 1, $_POST['email'], $_POST['nome'], $_POST['login'], $_POST['senha'], $_POST['telefone']);
                        $crud->atualizaUsuario($upFun, $_POST['cpfFun']);
                        $sorvetes = $crud2->getSorvetes();
